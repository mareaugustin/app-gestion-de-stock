...
from authentifications import views as user_views
...
urlpatterns = [
    ...
    path('login/', auth_views.LoginView.as_view(
        template_name='authentifications/login.html'), name='user-login'),
    path('profile/', user_views.profile, name='user-profile'),
    path('profile/update/', user_views.profile_update,
         name='user-profile-update'),
    path('logout/', auth_views.LogoutView.as_view(
        template_name='authentifications/logout.html'), name='user-logout'),
